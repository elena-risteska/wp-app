  ...
  return (
    <>
      <button
        ...
        type="button"
        className="w-fit float-right py-2 px-4 mx-2 cursor-pointer text-sm font-semibold tracking-wider text-white bg-stone-800 hover:bg-stone-700 focus:outline-none"
      >
        Edit
      </button>
      {modal ? (
                  ...
                  <form className="max-w-lg w-full mx-auto" action="#">
                    ...
                    <div className="mt-12">
                      <input
                        type="submit"
                        value="Save changes"
                        className="w-full py-3 px-6 cursor-pointer text-sm font-semibold tracking-wider text-white bg-stone-900 hover:bg-stone-800 focus:outline-none"
                      />
                    </div>
                    <div className="mt-8">
                      <button
                        ...
                        className="float-left w-1/3 py-3 px-4 cursor-pointer text-sm font-semibold tracking-wider text-white bg-stone-800 hover:bg-stone-700 focus:outline-none"
                      >
                        Reset
                      </button>
                      <button
